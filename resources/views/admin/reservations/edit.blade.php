        ...
        <div>
            <form action="{{ route('admin.reservations.update', $reservation->id) }}" method="post">
                ...
                <div class="mb-2 max-w-3xl mx-auto">
                    ...
                    <input type="datetime-local" name="res_date" id="res_date" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
